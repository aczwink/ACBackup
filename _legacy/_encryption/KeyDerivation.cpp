...
Tuple<FixedArray<uint8>, FixedArray<uint8>> DeriveAppKey()
{
	...
	//hash the pw
	UniquePointer<Crypto::HashFunction> hashFunction = Crypto::HashFunction::CreateInstance(HashAlgorithm::SHA512);
...
FixedArray<uint8> GenerateVerificationMessage()
{
	...
	//hash message
	UniquePointer<Crypto::HashFunction> hashFunction = Crypto::HashFunction::CreateInstance(HashAlgorithm::SHA256);
